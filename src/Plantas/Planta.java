...
public class Planta {
    ...
    public static ProductorChasis[] vecProdChasis;
    public static ProductorCarroceria[] vecProdCarroc;
    ...
    public void productorChasis() {
        ...
        vecProdChasis[posVecChasis] = new ProductorChasis(driveChasis, pChasis, mChasis, eChasis, maxEmpleados - 10);
